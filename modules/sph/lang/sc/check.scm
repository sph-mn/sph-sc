(define-module (sph lang sc check))

(use-modules (srfi srfi-2) (ice-9 match)
  (sph) (sph alist) (sph lang sc expressions) (sph list) ((sph tree) #:select (tree-every)))

(export sc-syntax-check sc-syntax-error
  sc-syntax-error? sc-syntax-examples sph-lang-sc-check-description)

(define sph-lang-sc-check-description
  "syntax checks, examples and error handling.
   sc-syntax-examples are used in error messages as examples of what is allowed")
